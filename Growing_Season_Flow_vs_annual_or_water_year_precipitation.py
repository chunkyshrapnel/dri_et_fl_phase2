...
dict_var_to_string_conversion = {
    'mean_growing_season_flow': 'Mean Growing Season Flow (cfs)',
...
# plots where weach plot corresponds to a site.
...
def create_normalized_combined_plot():



def main():
    create_site_plots('mean_growing_season_flow', 'ann_pr')
    create_site_plots('mean_growing_season_flow', 'wy_pr')
    create_site_plots('mean_growing_season_flow', 'gs_pr')
